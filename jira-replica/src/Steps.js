...
function Steps({taskData,stepNumber,rightArrow,leftArrow,updateData,deleteTask}) {
  ...
  <Grid item xs={3} >
    <Box style={{minHeight:"500px",backgroundColor:"#E4E7EE",paddingBottom:"5px"}}>
      ...
      { 
        taskData.map((values)=>{
return <Tasks taskNumber={values.taskNumber} taskId={values.taskId} stepNumber={stepNumber} updateData={updateData} deleteTask={deleteTask} rightArrow={rightArrow} leftArrow={leftArrow}/>
        })
      }
